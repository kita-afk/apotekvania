...
<div class="top_nav">
	<div class="nav_menu">
		<nav>
          ...
          ?>
					<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url('assets/images/img.jpg') ?>" alt=""><?=  $akun['nama'];  ?> <!-- <span class="fa fa-angle-down"></span> --></a>
					<!--
